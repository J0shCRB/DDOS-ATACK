'''.bash
Disclaimer: Este script es solo para fines educativos. El autor no es responsable de ningun problema o daño causado por este script;Este script esta totalmente liberado de virus y bats,#09,este codigo esta echo por josh 
instagram:JOSHHITO
YT:DARKZ DXM
